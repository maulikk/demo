...
console.log("standardApplicationRequest >>",$scope.standardApplicationRequest);
console.log("optionalApplicationRequest >>",$scope.optionalApplicationRequest);
...
// This service is for the step form
                service.optfunctions = function ($scope) {
                	console.log("optfunctions called",$scope);
